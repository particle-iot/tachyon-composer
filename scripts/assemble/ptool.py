...
# REFERENCES
#
#  $Header: //components/rel/config.glue/304.0/storage/ptool.py#3 $
#  $DateTime: 2024/12/13 01:22:19 $
#  $Author: pwbldsvc $
#
# when          who     what, where, why
# --------      ---     -------------------------------------------------------
# 2020-03-10    wek     Python 3 support.
...
#            print "===============================================================================\n"
    ...
    UpdateRawProgram(RawProgramXML_Wipe,0,  1*SECTOR_SIZE_IN_BYTES/1024.0, PhysicalPartitionNumber, 0,  1, "zeros_1sector.bin", 'false', 'PrimaryGPT','false','true')
